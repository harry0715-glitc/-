...
主承包商由主要管理者直接管理，不配發次管理者。次承包商帳號的公司範圍由 Apps Script 依登入帳號決定；前端傳入其他公司代碼時，後端仍會拒絕。

停用或隨承包商封存次管理者時，系統會撤銷該帳號對既有雲端 PDF 的檢視權。對方先前已下載到自己裝置的副本無法遠端收回，因此帳號與臨時密碼應分開傳送，離職或更換管理者時要立即停用帳號。
...
次管理者的 Email 建議使用可登入 Google Drive 的 Google 帳號，才能開啟系統產生並授權給他的私密 PDF。
